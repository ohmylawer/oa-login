...
public class AuthorizeTag extends LegacyAuthorizeTag {
    ...
    private int authorizeUsingAccessExpression(Authentication currentUser) throws JspException {
        // Get web expression
        MyWebSecurityExpressionHandler handler = getExpressionHandler();
    ...
    MyWebSecurityExpressionHandler getExpressionHandler() throws JspException {
        ServletContext servletContext = pageContext.getServletContext();
        ApplicationContext ctx = WebApplicationContextUtils.getRequiredWebApplicationContext(servletContext);
        Map<String, MyWebSecurityExpressionHandler> expressionHdlrs = ctx.getBeansOfType(MyWebSecurityExpressionHandler.class);
        ...
        return (MyWebSecurityExpressionHandler) expressionHdlrs.values().toArray()[0];
    }
